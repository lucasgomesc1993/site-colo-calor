...
export const post: BlogPost = {
  ...
  content: `
    ...
    <h3 class="font-cormorant text-2xl text-terracotta mt-8 mb-4">Estudos demonstram:</h3>
    <ul class="list-disc pl-5 space-y-2 mb-8">
      <li>Redução significativa da dor</li>
      <li>Aceleração da cicatrização de tecidos</li>
      <li>Diminuição de processos inflamatórios</li>
    </ul>

    <h3 class="font-cormorant text-2xl text-terracotta mt-8 mb-4">É indicada para:</h3>
    <ul class="list-disc pl-5 space-y-2 mb-8">
      <li>Fissuras mamárias</li>
      <li>Ingurgitamento (mama muito cheia)</li>
      <li>Dor pós-parto</li>
      <li>Assaduras em bebês</li>
    </ul>
