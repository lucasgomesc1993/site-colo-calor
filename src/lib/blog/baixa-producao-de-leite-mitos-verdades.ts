...
export const post: BlogPost = {
    ...
    <h3 class="font-cormorant text-2xl text-terracotta mt-8 mb-4">Na maioria das vezes, o problema está em:</h3>
    <ul class="list-disc pl-5 space-y-2 mb-8">
      <li>Esvaziamento ineficiente</li>
      <li>Interferências precoces</li>
      <li>Estresse</li>
      <li>Falta de suporte</li>
    </ul>

    <h3 class="font-cormorant text-2xl text-terracotta mt-8 mb-4">A produção depende de:</h3>
    <ul class="list-disc pl-5 space-y-2 mb-8">
      <li>Estímulo adequado</li>
      <li>Frequência</li>
      <li>Remoção eficaz do leite</li>
    </ul>
